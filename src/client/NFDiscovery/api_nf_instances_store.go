...
// Analytics Id(s) of Nnwdaf_MLModelProvision service
func (r ApiSearchNFInstancesRequest) MlAnalyticsIdList(mlAnalyticsIdList []NwdafEvent) ApiSearchNFInstancesRequest {
	r.mlAnalyticsIdList = &mlAnalyticsIdList
	return r
}
...
// Indicating the precedence of the preference query parameters (from higher to lower).
...
func (a *NFInstancesStoreApiService) SearchNFInstancesExecute(r ApiSearchNFInstancesRequest) (*SearchResult, *http.Response, error) {
	...
	if r.preferredCollocatedNfTypes != nil {
		localVarQueryParams.Add("preferred-collocated-nf-types", parameterToString(*r.preferredCollocatedNfTypes, "csv"))
	}
	...
	if r.requesterPlmnSpecificSnssaiList != nil {
		localVarQueryParams.Add("requester-plmn-specific-snssai-list", parameterToString(*r.requesterPlmnSpecificSnssaiList, "csv"))
	}
	if r.dnn != nil {
	...
	if r.mbsmfServingArea != nil {
		localVarQueryParams.Add("mbsmf-serving-area", parameterToString(*r.mbsmfServingArea, ""))
	}
	if r.tai != nil {
	...
	if r.preferredPgwInd != nil {
		localVarQueryParams.Add("preferred-pgw-ind", parameterToString(*r.preferredPgwInd, ""))
	}
	if r.pgw != nil {
		localVarQueryParams.Add("pgw", parameterToString(*r.pgw, ""))
	}
	if r.pgwIp != nil {
		localVarQueryParams.Add("pgw-ip", parameterToString(*r.pgwIp, ""))
	}
	if r.gpsi != nil {
	...
	if r.internalGroupIdentity != nil {
		localVarQueryParams.Add("internal-group-identity", parameterToString(*r.internalGroupIdentity, ""))
	}
	if r.pfdData != nil {
		localVarQueryParams.Add("pfd-data", parameterToString(*r.pfdData, ""))
	}
	if r.dataSet != nil {
	...
	if r.maxPayloadSizeExt != nil {
		localVarQueryParams.Add("max-payload-size-ext", parameterToString(*r.maxPayloadSizeExt, ""))
	}
	...
	if r.clientType != nil {
		localVarQueryParams.Add("client-type", parameterToString(*r.clientType, ""))
	}
	if r.lmfId != nil {
		localVarQueryParams.Add("lmf-id", parameterToString(*r.lmfId, ""))
	}
	if r.anNodeType != nil {
		localVarQueryParams.Add("an-node-type", parameterToString(*r.anNodeType, ""))
	}
	if r.ratType != nil {
		localVarQueryParams.Add("rat-type", parameterToString(*r.ratType, ""))
	}
	if r.preferredTai != nil {
		localVarQueryParams.Add("preferred-tai", parameterToString(*r.preferredTai, ""))
	}
	if r.preferredNfInstances != nil {
		localVarQueryParams.Add("preferred-nf-instances", parameterToString(*r.preferredNfInstances, "csv"))
	}
	if r.targetSnpn != nil {
		localVarQueryParams.Add("target-snpn", parameterToString(*r.targetSnpn, ""))
	}
	if r.requesterSnpnList != nil {
		localVarQueryParams.Add("requester-snpn-list", parameterToString(*r.requesterSnpnList, "csv"))
	}
	if r.afEeData != nil {
		localVarQueryParams.Add("af-ee-data", parameterToString(*r.afEeData, ""))
	}
	if r.wAgfInfo != nil {
		localVarQueryParams.Add("w-agf-info", parameterToString(*r.wAgfInfo, ""))
	}
	if r.tngfInfo != nil {
		localVarQueryParams.Add("tngf-info", parameterToString(*r.tngfInfo, ""))
	}
	if r.twifInfo != nil {
		localVarQueryParams.Add("twif-info", parameterToString(*r.twifInfo, ""))
	}
	if r.targetNfSetId != nil {
		localVarQueryParams.Add("target-nf-set-id", parameterToString(*r.targetNfSetId, ""))
	}
	if r.targetNfServiceSetId != nil {
		localVarQueryParams.Add("target-nf-service-set-id", parameterToString(*r.targetNfServiceSetId, ""))
	}
	if r.nefId != nil {
		localVarQueryParams.Add("nef-id", parameterToString(*r.nefId, ""))
	}
	if r.notificationType != nil {
		localVarQueryParams.Add("notification-type", parameterToString(*r.notificationType, ""))
	}
	if r.n1MsgClass != nil {
		localVarQueryParams.Add("n1-msg-class", parameterToString(*r.n1MsgClass, ""))
	}
	if r.n2InfoClass != nil {
		localVarQueryParams.Add("n2-info-class", parameterToString(*r.n2InfoClass, ""))
	}
	if r.servingScope != nil {
		localVarQueryParams.Add("serving-scope", parameterToString(*r.servingScope, "csv"))
	}
	if r.imsi != nil {
		localVarQueryParams.Add("imsi", parameterToString(*r.imsi, ""))
	}
	if r.imsPrivateIdentity != nil {
		localVarQueryParams.Add("ims-private-identity", parameterToString(*r.imsPrivateIdentity, ""))
	}
	if r.imsPublicIdentity != nil {
		localVarQueryParams.Add("ims-public-identity", parameterToString(*r.imsPublicIdentity, ""))
	}
	if r.msisdn != nil {
		localVarQueryParams.Add("msisdn", parameterToString(*r.msisdn, ""))
	}
	if r.preferredApiVersions != nil {
		localVarQueryParams.Add("preferred-api-versions", parameterToString(*r.preferredApiVersions, ""))
	}
	if r.v2xSupportInd != nil {
		localVarQueryParams.Add("v2x-support-ind", parameterToString(*r.v2xSupportInd, ""))
	}
	if r.redundantGtpu != nil {
		localVarQueryParams.Add("redundant-gtpu", parameterToString(*r.redundantGtpu, ""))
	}
	if r.redundantTransport != nil {
		localVarQueryParams.Add("redundant-transport", parameterToString(*r.redundantTransport, ""))
	}
	if r.ipups != nil {
		localVarQueryParams.Add("ipups", parameterToString(*r.ipups, ""))
	}
	if r.scpDomainList != nil {
		localVarQueryParams.Add("scp-domain-list", parameterToString(*r.scpDomainList, "csv"))
	}
	if r.addressDomain != nil {
		localVarQueryParams.Add("address-domain", parameterToString(*r.addressDomain, ""))
	}
	if r.ipv4Addr != nil {
		localVarQueryParams.Add("ipv4-addr", parameterToString(*r.ipv4Addr, ""))
	}
	if r.ipv6Prefix != nil {
		localVarQueryParams.Add("ipv6-prefix", parameterToString(*r.ipv6Prefix, ""))
	}
	if r.servedNfSetId != nil {
		localVarQueryParams.Add("served-nf-set-id", parameterToString(*r.servedNfSetId, ""))
	}
	if r.remotePlmnId != nil {
		localVarQueryParams.Add("remote-plmn-id", parameterToString(*r.remotePlmnId, ""))
	}
	if r.dataForwarding != nil {
		localVarQueryParams.Add("data-forwarding", parameterToString(*r.dataForwarding, ""))
	}
	if r.preferredFullPlmn != nil {
		localVarQueryParams.Add("preferred-full-plmn", parameterToString(*r.preferredFullPlmn, ""))
	}
	if r.requesterFeatures != nil {
		localVarQueryParams.Add("requester-features", parameterToString(*r.requesterFeatures, ""))
	}
	if r.realmId != nil {
		localVarQueryParams.Add("realm-id", parameterToString(*r.realmId, ""))
	}
	if r.storageId != nil {
		localVarQueryParams.Add("storage-id", parameterToString(*r.storageId, ""))
	}
	if r.vsmfSupportInd != nil {
		localVarQueryParams.Add("vsmf-support-ind", parameterToString(*r.vsmfSupportInd, ""))
	}
	if r.nrfDiscUri != nil {
		localVarQueryParams.Add("nrf-disc-uri", parameterToString(*r.nrfDiscUri, ""))
	}
	if r.preferredVendorSpecificFeatures != nil {
		localVarQueryParams.Add("preferred-vendor-specific-features", parameterToString(*r.preferredVendorSpecificFeatures, ""))
	}
	if r.preferredVendorSpecificNfFeatures != nil {
		localVarQueryParams.Add("preferred-vendor-specific-nf-features", parameterToString(*r.preferredVendorSpecificNfFeatures, ""))
	}
	if r.requiredPfcpFeatures != nil {
		localVarQueryParams.Add("required-pfcp-features", parameterToString(*r.requiredPfcpFeatures, ""))
	}
	if r.homePubKeyId != nil {
		localVarQueryParams.Add("home-pub-key-id", parameterToString(*r.homePubKeyId, ""))
	}
	if r.proseSupportInd != nil {
		localVarQueryParams.Add("prose-support-ind", parameterToString(*r.proseSupportInd, ""))
	}
	if r.analyticsAggregationInd != nil {
		localVarQueryParams.Add("analytics-aggregation-ind", parameterToString(*r.analyticsAggregationInd, ""))
	}
	if r.servingNfSetId != nil {
		localVarQueryParams.Add("serving-nf-set-id", parameterToString(*r.servingNfSetId, ""))
	}
	if r.servingNfType != nil {
		localVarQueryParams.Add("serving-nf-type", parameterToString(*r.servingNfType, ""))
	}
	if r.mlAnalyticsIdList != nil {
		localVarQueryParams.Add("ml-analytics-id-list", parameterToString(*r.mlAnalyticsIdList, "csv"))
	}
	if r.analyticsMetadataProvInd != nil {
		localVarQueryParams.Add("analytics-metadata-prov-ind", parameterToString(*r.analyticsMetadataProvInd, ""))
	}
	if r.nsacfCapability != nil {
		localVarQueryParams.Add("nsacf-capability", parameterToString(*r.nsacfCapability, ""))
	}
	if r.mbsSessionIdList != nil {
		localVarQueryParams.Add("mbs-session-id-list", parameterToString(*r.mbsSessionIdList, "csv"))
	}
	if r.areaSessionId != nil {
		localVarQueryParams.Add("area-session-id", parameterToString(*r.areaSessionId, ""))
	}
	if r.gmlcNumber != nil {
		localVarQueryParams.Add("gmlc-number", parameterToString(*r.gmlcNumber, ""))
	}
	if r.upfN6Ip != nil {
		localVarQueryParams.Add("upf-n6-ip", parameterToString(*r.upfN6Ip, ""))
	}
	if r.taiList != nil {
		localVarQueryParams.Add("tai-list", parameterToString(*r.taiList, "csv"))
	}
	if r.preferencesPrecedence != nil {
		localVarQueryParams.Add("preferences-precedence", parameterToString(*r.preferencesPrecedence, "csv"))
	}
	if r.supportOnboardingCapability != nil {
		localVarQueryParams.Add("support-onboarding-capability", parameterToString(*r.supportOnboardingCapability, ""))
	}
	if r.uasNfFunctionalityInd != nil {
		localVarQueryParams.Add("uas-nf-functionality-ind", parameterToString(*r.uasNfFunctionalityInd, ""))
	}
	if r.v2xCapability != nil {
		localVarQueryParams.Add("v2x-capability", parameterToString(*r.v2xCapability, ""))
	}
	if r.proseCapability != nil {
		localVarQueryParams.Add("prose-capability", parameterToString(*r.proseCapability, ""))
	}
	if r.sharedDataId != nil {
		localVarQueryParams.Add("shared-data-id", parameterToString(*r.sharedDataId, ""))
	}
	if r.targetHni != nil {
		localVarQueryParams.Add("target-hni", parameterToString(*r.targetHni, ""))
	}
